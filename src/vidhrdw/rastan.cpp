...
int rastan_vh_start (void)
{
	...
	rastan_dirty1 = (unsigned char *)gp2x_malloc ( rastan_videoram_size/4);
	if (!rastan_dirty1)
	{
		rastan_vh_stop();
		return 1;
	}
	fast_memset(rastan_dirty1,1,rastan_videoram_size / 4);

	rastan_dirty3 = (unsigned char *)gp2x_malloc ( rastan_videoram_size/4);
	if (!rastan_dirty3)
	{
		rastan_vh_stop();
		return 1;
	}
	fast_memset(rastan_dirty3,1,rastan_videoram_size / 4);
...
void rastan_vh_stop (void)
{
	...
	/* Free video RAM */
	if (rastan_dirty1)
	        gp2x_free (rastan_dirty1);
	if (rastan_dirty3)
	        gp2x_free (rastan_dirty3);
