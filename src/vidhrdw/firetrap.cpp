...
{
	if ((dirtybuffer = (unsigned char *)gp2x_malloc(firetrap_bgvideoram_size)) == 0)
	{
		return 1;
	}
	fast_memset(dirtybuffer,1,firetrap_bgvideoram_size);
	...
	if ((dirtybuffer2 = (unsigned char *)gp2x_malloc(firetrap_bgvideoram_size)) == 0)
	{
		osd_free_bitmap(tmpbitmap);
		gp2x_free(dirtybuffer);
		return 1;
	}
	fast_memset(dirtybuffer2,1,firetrap_bgvideoram_size);
