	...
	if( flags&TILE_FLIPX ){
		...
		for( sy=y1; sy!=y2; sy+=dy ){
			...
			for( x=tile_width/8; x>=0; x-- ){
				unsigned char data;
				data = (((1<<(*pendata++))&transmask)?0x00:0x80);
				data = (data>>1)| (((1<<(*pendata++))&transmask)?0x00:0x80);
				data = (data>>1)| (((1<<(*pendata++))&transmask)?0x00:0x80);
				data = (data>>1)| (((1<<(*pendata++))&transmask)?0x00:0x80);
				data = (data>>1)| (((1<<(*pendata++))&transmask)?0x00:0x80);
				data = (data>>1)| (((1<<(*pendata++))&transmask)?0x00:0x80);
				data = (data>>1)| (((1<<(*pendata++))&transmask)?0x00:0x80);
				mask_dest[x] = (data>>1)| (((1<<(*pendata++))&transmask)?0x00:0x80);
			}
#endif
		}
	}
		...
		for( sy=y1; sy!=y2; sy+=dy ){
			...
			for( x=0; x<tile_width/*/8*/; x++ ){
				unsigned char data;
				data = (((1<<(*pendata++))&transmask)==0);
				data = (data<<1)| (((1<<(*pendata++))&transmask)==0);
				data = (data<<1)| (((1<<(*pendata++))&transmask)==0);
				data = (data<<1)| (((1<<(*pendata++))&transmask)==0);
				data = (data<<1)| (((1<<(*pendata++))&transmask)==0);
				data = (data<<1)| (((1<<(*pendata++))&transmask)==0);
				data = (data<<1)| (((1<<(*pendata++))&transmask)==0);
				mask_dest[x] = (data<<1)| (((1<<(*pendata++))&transmask)==0);
			}
#endif
		}
	}
