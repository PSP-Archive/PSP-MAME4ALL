...
void combatsc_init_machine( void )
{
	...
	fast_memcpy( &MEM[0x8000], &MEM[0x18000], 0x8000 ); /* map upper half of ROM */
	...
	fast_memset( combatsc_io_ram,0x00, 0x4000 );
	fast_memset( combatsc_page0,0x00, 0x2000 );
	fast_memset( combatsc_page1,0x00, 0x2000 );
