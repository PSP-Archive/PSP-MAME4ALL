...
#else
#define read_dword(addr) ( ((((unsigned char *)(addr))[BL0])) | ((((unsigned char *)(addr))[BL1]) <<  8) | ((((unsigned char *)(addr))[BL2]) << 16) | ((((unsigned char *)(addr))[BL3]) << 24) )
#define write_dword(addr,value) ( ((unsigned char *)(addr))[BL0] = (unsigned char)((int)(value)), ((unsigned char *)(addr))[BL1] = (unsigned char)((int)(value) >>  8), ((unsigned char *)(addr))[BL2] = (unsigned char)((int)(value) >> 16), ((unsigned char *)(addr))[BL3] = (unsigned char)((int)(value) >> 24) )
...
int readroms(void)
{
	...
	for (region = 0;region < MAX_MEMORY_REGIONS;region++)
	{
		...
		Machine->memory_region_length[region] = 0;
	}
